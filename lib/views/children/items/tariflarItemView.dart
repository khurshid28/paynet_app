...
class TariflarItemView extends StatefulWidget {
  List data;
  Color backColor;
  Color itemColor;
  TariflarItemView(
  ...
  @override
  State<TariflarItemView> createState() => _TariflarItemViewState();
}

class _TariflarItemViewState extends State<TariflarItemView> {
                            ...
                            child: Row(
                              ...
                              children: [
                                Text(
                                  "Narxi: ",
                                  style: TextStyle(
                                      color: itemColor, fontSize: 12.sp),
                                ),
                                Text(
