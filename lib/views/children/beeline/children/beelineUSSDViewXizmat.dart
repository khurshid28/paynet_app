...
class BeelineUSSDViewXizmat extends StatefulWidget {
  const BeelineUSSDViewXizmat({Key? key}) : super(key: key);

  @override
  State<BeelineUSSDViewXizmat> createState() => _BeelineUSSDViewState();
}

class _BeelineUSSDViewState extends State<BeelineUSSDViewXizmat> {
  @override
