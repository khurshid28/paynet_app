...
class BeelineUSSDViewKods extends StatefulWidget {
  const BeelineUSSDViewKods({Key? key}) : super(key: key);

  @override
  State<BeelineUSSDViewKods> createState() => _BeelineUSSDViewState();
}

class _BeelineUSSDViewState extends State<BeelineUSSDViewKods> {
  @override
